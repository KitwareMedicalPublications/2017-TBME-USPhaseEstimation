...
%
\includegraphics[width=6.25in]{ecg_instaphase_overlay.png}\\
\ionbox{6.25in}\\
\includegraphics[width=6.25in]{qrs_peak_to_peak.png}\\
\includegraphics[width=6.25in]{instaphase_valley_to_valley.png}
\ionbox{6.25in}\\
%
...
\setcounter{lfigcounter}{1}
%
\includegraphics[width=5.75in]{simMat.png}
\ionbox{1.92in}\ionbox{1.92in}\ionbox{1.92in}\\
\includegraphics[width=5.75in]{season_trend_decomposition.png}
\ionbox{5.75in}\\
\includegraphics[width=5.75in]{periodogram.png}
\ionbox{5.75in}\\
\includegraphics[width=5.75in]{instantaneous_phase.png}
\ionbox{5.75in}\\
%
...
\setcounter{lfigcounter}{1}
%
\includegraphics[width=6.25in]{respiratory_phase_gating.png}
\ionbox{6.25in}\\
\includegraphics[width=6.25in]{robust_lowess_gating.png}
\ionbox{6.25in}\\
\includegraphics[width=6.25in]{phaseordered.png}
...
\setcounter{lfigcounter}{1}
%
\includegraphics[width=6.05in]{phase_similarity_bandwidth.png}\\
\ionbox{6.05in}\\
\includegraphics[height=2.05in]{Input_Mag_1_kernel_regression_phase_sim.png}
\hspace{0.02cm}
\includegraphics[height=2.05in]{Input_Mag_2_kernel_regression_phase_sim.png}
\hspace{0.02cm}
\includegraphics[height=2.05in]{Input_Mag_4_kernel_regression_phase_sim.png}
\hspace{0.02cm}
\includegraphics[height=2.05in]
{Input_Mag_8_kernel_regression_phase_sim.png}
\hspace{1.0cm}
\includegraphics[height=2.05in]{Input_Mag_1_kernel_regression_phase.png}
\hspace{0.02cm}
\includegraphics[height=2.05in]{Input_Mag_2_kernel_regression_phase.png}
\hspace{0.02cm}
\includegraphics[height=2.05in]{Input_Mag_4_kernel_regression_phase.png}
\hspace{0.02cm}
\includegraphics[height=2.05in]
{Input_Mag_8_kernel_regression_phase.png}\\
...
\setcounter{lfigcounter}{1}
%
\includegraphics[width=0.9 \linewidth]{single_cycle_video_reconstruction.png}
%
